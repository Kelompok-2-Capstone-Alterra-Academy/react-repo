					...
					<Grid item xs={12} md={6}>
						<div className="pr-10">
							...
							<Typography
								...
								Kami dari perusahaan Staredu memiliki visi untuk menghadirkan pendidikan berkualitas
								kepada semua orang melalui platform e-learning inovatif kami. Dengan menggunakan
								teknologi canggih dan pendekatan pedagogis yang efektif, kami berkomitmen untuk
								mengubah cara orang belajar dan memberikan peluang pendidikan yang tidak terbatas.
							</Typography>
						</div>
					</Grid>
			...
			<Box sx={{ py: '50px' }}>
				<Container maxWidth={'xl'}>
					...
					<Typography
						...
						Kami memprioritaskan kualitas dan keunggulan akademik dalam semua aspek platform
						e-learning kami.
					</Typography>
				</Container>
			</Box>
				...
				<Container maxWidth={'xl'}>
					<Grid container>
						<Grid item xs={12} md={6} mb={'2rem'}>
							<img src="/image/aboutUs-CEO.png" className="rounded-[20px]" alt="" />
						</Grid>
						<Grid
							item
							xs={12}
							...
							<Box
								...
								<Typography variant="h5" mb={'10px'} fontWeight={600} color={'#2196F3'}>
									CEO - StarEdu
								</Typography>
							</Box>
						</Grid>
