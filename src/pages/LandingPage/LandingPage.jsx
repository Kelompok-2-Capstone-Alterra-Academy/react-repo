...
import { Box, Button, Card, CardContent, CardMedia, Container, Grid, Link, List, ListItem, Typography, } from '@mui/material';
    ...
    <div>
          ...
          <Grid item xs={12} md={6}>
            <div>
              ...
              <Typography my={3.5} sx={{ fontSize: "11pt", color: "#212121" }}>
                Kami Hadir sebagai Wadah untuk seluruh Pahlawan Pendidikan{" "}
                <br />
              ...
              <Button
                sx={{
                  width: "210px",
                  background:
                    "linear-gradient(180deg, #2196F3 19.19%, #4161FF 100%)",
                  ...
                  ":hover": {
                    background:
                      "linear-gradient(180deg, #1f87db 19.19%, #3854e0 100%)",
                  },
                }}
              >
                Gabung Sekarang
          ...
          <Grid container spacing={2}>
            ...
            >
              ...
              <Box>
                <Typography
                  mb={1.5}
                  sx={{ fontSize: "17pt", fontWeight: "600", color: "#212121" }}
                >
                  Sharing Ilmu
                </Typography>
                <Typography sx={{ fontSize: "10pt" }}>
                  Bagikan Keahlian dan Pengetahuanmu dengan Jutaan Siswa di
                  Indonesia
                </Typography>
              </Box>
            </Grid>
            ...
            >
              ...
              <Box sx={{ transform: {xs:"scaleX(-1)", md:"scaleX(1)"}, textAlign:{xs:'right', md:'left'}}}>
                <Typography
                  mb={1.5}
                  sx={{ fontSize: "17pt", fontWeight: "600", color: "#212121" }}
                >
            ...
            >
              ...
              <Box>
                ...
                <Typography sx={{ fontSize: "10pt" }}>
                  Selain Berbagi Kebaikan, Kamu juga Bisa Meraih Penghasilan
                  Tambahan
                </Typography>
              </Box>
            </Grid>
            ...
            <Grid item xs={12} md={10} lg={8} xl={8} sx={{ mb: "30px" }}>
              ...
              >
                ...
                <Box sx={{ maxWidth: { xs: "75%", md: "70%", lg: "60%" } }}>
                  ...
                  >
                    “Sejak bergabung dengan platform ini saya merasa lebih mudah
                    dalam mengajar dan saya mendapatkan akses ke lebih banyak
                    siswa serta mendapatkan dukungan teknologi yang sangat
                    membantu."
                  </Typography>
                  <Typography
                    sx={{
            ...
            <Grid item xs={12} md={10} lg={8} xl={8}>
              ...
              >
                ...
                >
                  ...
                  >
                    "Saya sangat senang bergabung dengan platform kursus online
                    ini. Saya dapat menjangkau lebih banyak siswa dan
                    meningkatkan pendapatan saya sebagai mentor. Selain itu,
                    dukungan teknologi yang diberikan sangat membantu dalam
                    memudahkan pengajaran online."
                  </Typography>
                  <Typography
                    sx={{
                      fontSize: {
      ...
      <Box
        sx={{
          py: "70px",
          background:
            "linear-gradient(180.78deg, #F0FAFF 1.04%, rgba(187, 222, 251, 0) 82.65%)",
        }}
      >
        <Container maxWidth={"xl"}>
          <Typography
              ...
              >
                ...
                <CardContent sx={{ py: "1rem", px: "2rem", color: "#fff" }}>
                  ...
                  <Typography variant="body2" sx={{ fontSize: "11pt" }}>
                    Mentor dapat mengelola data siswa dengan mudah serta dapat
            ...
            <Grid item xs={12} md={4} sx={{}}>
              ...
              >
                ...
                <CardContent sx={{ py: "1rem", px: "2rem", color: "#fff" }}>
                  ...
                  <Typography variant="body2" sx={{ fontSize: "11pt" }}>
                    Mentor dapat mengatur jadwal kelas dengan mudah dan efisien.
                    Fitur ini dapat membantu memastikan bahwa siswa memiliki
            ...
            <Grid item xs={12} md={4} sx={{}}>
              ...
              >
                ...
                <CardContent sx={{ py: "1rem", px: "2rem", color: "#fff" }}>
                  ...
                  <Typography variant="body2" sx={{ fontSize: "11pt" }}>
                    mentor dapat mengatur setiap kelas dengan mudah. Ini
                    mencakup pengiriman materi pelajaran, tugas, ujian, dan
                    pekerjaan rumah.
                  </Typography>
                </CardContent>
                <Box sx={{ display: "flex", justifyContent: "center" }}>
