      ...
      >
        <Container maxWidth={"xl"}>
          <Grid container spacing={2}>
            ...
            >
              <img
                src="/img/Free_Vector___Colleagues_working_together_on_project.png"
                alt=""
              />
            </Grid>
            <Grid
            ...
            >
              <Box>
                ...
                >
                  Komunitas Mentor Terbaik dan <br /> Nikmati Manfaat yang Lebih
                  Besar
                </Typography>
                <ListItem my={3} sx={{ display: "block" }}>
                  <li className="py-1.5">Meningkatkan pengalaman mengajar</li>
                  <li className="py-1.5">
                    Akses ke jaringan mentor dan siswa yang lebih luas
                  </li>
                  <li className="py-1.5">
                    Dukungan teknologi yang kuat untuk memudahkan pengajaran
                    online
                  </li>
                  <li className="py-1.5">
                    Peluang untuk memperluas bisnis Anda dan mendapatkan
