                    ...
                    <div className='grid grid-cols-2 gap-4 mt-20'>
                        ...
                        <div className="flex items-center gap-4">
                            <div>
                                ...
                                />
                                <label htmlFor="male" className="ml-2 text-sm font-medium text-gray-800">Male</label>
                            </div>
                            <div>
                                <input
                                    id="female"
                                    ...
                                    onChange={(e) => setGender(e.target.value)}
                                />
                                <label htmlFor="female" className="ml-2 text-sm font-medium text-gray-800">Female</label>
                            </div>
                        </div>
