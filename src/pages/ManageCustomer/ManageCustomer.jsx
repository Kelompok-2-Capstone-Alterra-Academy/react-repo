								...
								<Box className="absolute right-1/2 top-1/3 translate-x-1/2 bg-white rounded-lg p-7">
									...
									<div>
										<StyledToggleButtonGroup
											...
											<StyledToggleButton value="descending" aria-label="italic">
									...
									<div>
										<StyledToggleButtonGroup
											...
											<StyledToggleButton value="ascending" aria-label="bold" className="w-52">
												<BiSortAZ fontSize={20} className="mr-3" /> Terbaru
											</StyledToggleButton>
											<StyledToggleButton value="descending" aria-label="italic" className="w-52">
									...
									<div>
										<StyledToggleButtonGroup
											...
											className="space-x-10">
											<StyledToggleButton value="ascending" aria-label="bold" className="w-56">
												<TbSortAscending2 fontSize={20} className="mr-3" /> Siswa Aktif
											</StyledToggleButton>
											<StyledToggleButton value="descending" aria-label="italic" className="w-56">
